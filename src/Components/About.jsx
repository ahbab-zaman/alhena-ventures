...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between lg:px-12 px-6 py-16 bg-white">
      <div className="md:w-1/2 mb-8 md:mb-0">
        <h2 data-aos="flip-up" className="text-4xl font-bold mb-2">ABOUT OUR </h2>
        <h3 data-aos="flip-up" className="text-4xl font-semibold mb-8 ml-24">COMPANY</h3>
            ...
            <div className="mr-4">
              ...
              >
                ...
                <rect
                  ...
                  fill="#8FBEF5"
                ></rect>
                <rect y="29" width="12" height="11" fill="#8FBEF5"></rect>
                <rect
                  x="29"
                  y="59"
                  width="12"
            ...
            <div className="mr-4">
              ...
              >
                ...
                <path
                  ...
                  fill="#F5BEBE"
                ></path>
                <path d="M57.1298 27.8314L51.0124 27.8649C54.2117 29.312 56.4476 31.2106 57.6793 33.5342C58.4735 35.0326 58.6408 36.3573 58.6509 37.1613L67.1115 37.1656C66.95 34.7359 65.9245 32.4769 64.1826 30.7437C62.2938 28.8644 59.791 27.8315 57.1298 27.8315V27.8314ZM47.189 19.8186C47.189 21.4491 48.5143 22.7756 50.1435 22.7756C51.7726 22.7756 53.0979 21.4491 53.0979 19.8186C53.0979 18.188 51.7726 16.8613 50.1435 16.8613C48.5143 16.8613 47.189 18.1879 47.189 19.8186Z"></path>
                <path d="M59.3815 14.9502C60.4745 14.9502 61.3606 14.0641 61.3606 12.9711C61.3606 11.878 60.4745 10.9919 59.3815 10.9919C58.2884 10.9919 57.4023 11.878 57.4023 12.9711C57.4023 14.0641 58.2884 14.9502 59.3815 14.9502Z"></path>
              </svg>
            </div>
            <div>
              <p className="text-xl font-semibold">100%</p>
      ...
      <div className="md:w-1/2 w-full">
        <p data-aos="flip-up" className="text-gray-600 mb-8 text-lg text-justify">
          Alhena Ventures is a software development agency based in Dhaka,
          Bangladesh, specializing in creating advanced technology solutions for
          a global audience.
        </p>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-4">
          <div>
            <img
              src={about1}
              alt="Office 1"
              className="cursor-pointer animate-floating"
            />
            <p data-aos="flip-up" className="text-gray-600 text-lg mt-4 text-justify">
